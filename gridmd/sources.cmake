...
message("In sources.cmake: ${WITH_XML}")
if(WITH_XML)
  ...
  message("In WITH_XML: ${GRIDMD_SOURCES}")
endif(WITH_XML)
...
#Threadpool sources
if(USE_WXWIDGETS)
  file(GLOB THREADPOOL_SOURCES RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "${CMAKE_SOURCE_DIR}/wxint/wxthreadpool/src/*.cpp")
  file(GLOB THREADPOOL_HEADERS RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "${CMAKE_SOURCE_DIR}/wxint/wxthreadpool/include/*.h")
