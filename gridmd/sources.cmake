...
if(NOT USE_WXWIDGETS) #looks like it's either libxml2 or wxwidgets. So that here we use libxml2
  file(GLOB_RECURSE GRIDMD_SOURCES RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "src/gmd/*.cpp")
  file(GLOB_RECURSE GRIDMD_HEADERS RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "include/gmd/*.h")
