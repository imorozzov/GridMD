...
else(NOT USE_WXWIDGETS)
  file(GLOB_RECURSE GRIDMD_SOURCES RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "src/gmd/xml/*.cpp")
  file(GLOB_RECURSE GRIDMD_HEADERS RELATIVE ${CMAKE_CURRENT_SOURCE_DIR} "include/gmd/xml/*.h")
