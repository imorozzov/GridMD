...
No install scripts are prepared yet. You can just unpack the archive and add
the source files to your projects. The examples of GridMD usage are given in
